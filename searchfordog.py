...
import googlesearch
import subprocess
os.system("title dog search (made by gamestartergame)")
print("github: https://github.com/gamestartergame")
print("youtube: https://www.youtube.com/channel/UCk7nqcjq4od5hbf039Vn2QQ")
website =input("what website do you want to search dogs on (some websites might not work)\n")
cat = input("dogs:\n")
f = open(website + " with dogs.txt", "w")
...
input("press enter to start searching for dogs\n")
...
def google_search(count):
 ...
 for res in search("dogs" + cat + " site:" + website, tld="co.in", num=int(numofresults), stop=int(numofresults), pause=5):
  count = count + 1
